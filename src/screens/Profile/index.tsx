    ...
    render() {
        return (
            <TabBar>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={s.resumeContainer}>
                    ...
                    {resumeListJSON.map((resume: any, index: number) =>
                        <ResumeCard active value={resume} onClick={() => {
                        }}/>
                    )}
                </ScrollView>
                <Container>
                    <Title text={'Видео'} fontSize={18} left style={{marginBottom: 10}}/>
                    <View style={s.videoBlock}>
                        ...
                        <TouchableOpacity onPress={() => {}} style={{alignItems: 'center'}}>
                            <Image source={Icons.addVideo} style={[s.videoBlockImg, {width: 105, height: 105, bottom: 5}]} />
                        </TouchableOpacity>
                    </View>
                </Container>
                </ScrollView>
